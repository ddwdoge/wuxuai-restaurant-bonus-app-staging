...
set amount_per_point = case
  when amount_per_point between 0.65 and 0.69 then 1.0000
  when amount_per_point between 0.49 and 0.51 then round((1 / 1.1)::numeric, 4)
  when amount_per_point between 0.32 and 0.35 then round((1 / 1.2)::numeric, 4)
  else amount_per_point
end
where amount_per_point between 0.32 and 0.69;
